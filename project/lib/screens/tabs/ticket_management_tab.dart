                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 2),
                      Text('Issue Notes: ${t.issueNotes.isEmpty ? '-' : t.issueNotes}'),
                      const SizedBox(height: 2),
                      Text('Serial: ${t.serialNumber ?? '-'}'),
                      const SizedBox(height: 2),
                      Text('MFG Date: ${t.mfgDate?.toLocal().toString() ?? '-'}'),
                      const SizedBox(height: 2),
                      Text('Purchase Date: ${t.purchaseDate?.toLocal().toString() ?? '-'}'),
                      const SizedBox(height: 2),
                      Text('New Fan Complaint: ${t.newFanComplaint ? 'Yes' : 'No'}'),
                      const SizedBox(height: 2),
                      Text('Repeated Complaint: ${t.repeatedComplaintCount ?? '-'}'),
